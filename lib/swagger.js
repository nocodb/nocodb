...
class Swagger {
  ...
  addGetAll(routes, i, resourceCtrl, j, resource) {
    this.data.paths["/" + resource.resource]["get"] = {
      ...
      "description": "Returns all " + resource.resource + " in the database, limited at 100 entries.",
  ...
  addGetSingle(routes, i, resourceCtrl, j, resource) {
    this.data.paths["/" + resource.resource + "/{" + resource.resource + "Id}"] = {};
    this.data.paths["/" + resource.resource + "/{" + resource.resource + "Id}"]["get"] = {
      "tags": [resource.resource],
      "description": "Retrieve single entity of" + resource.resource,
      "operationId": "get" + resource.resource,
      "produces": [
        "application/json"
      ],
      "parameters": [
        {
          ...
          "in": "path",
          "required": true,
          "description": "The id of the " + resource.resource + " entity to retrieve",
          "type": "string"
        }
      ],
      "responses": {
      ...
      "parameters": [
        {
          ...
          "in": "body",
          "description": resource.resource + " entity to add to the database",
          "required": true,
          "schema": {
            "$ref": "#/definitions/" + resource.resource
          }
  ...
  addPutSingle(routes, i, resourceCtrl, j, resource) {
    this.data.paths["/" + resource.resource]["put"] = {
      "tags": [resource.resource],
      "description": "Replace an existing entity in " + resource.resource,
      "operationId": "replace" + resource.resource,
      "produces": [
        "application/json"
      ],
      "parameters": [
