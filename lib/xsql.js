...
class Xsql {
  ...
  _ownerAccess_where(req, tableName, queryParamsObj, oid=null){
    ...
    if (!!oid) {
      ...
      console.log(">>> req.route.path=", req.route.path, userSchema.tableName, joinTables )
      ...
      let predicate = queryParamsObj.query.toLowerCase().includes('where') ? " and " : " where ";
      console.log(">>> query=", queryParamsObj.query)
      this.getWhereClause(
