<template>
  <div>
    <v-progress-linear v-show="loading" color="success" indeterminate absolute height="4" />
    ...
    <v-tabs v-model="tab" style="height: 100%" height="40">
      ...
      <div v-if="!isDocker" class="flex-grow-1 d-flex text-right pr-4 justify-end">
        ...
        <template v-if="!isNoApis">
          ...
          <x-icon color="info info" :disabled="loading" tooltip="Clear (^ ⇧ E)" icon-class="mr-2" @click="clearScript">
