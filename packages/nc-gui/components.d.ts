...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    IcBaselineKeyboardDoubleArrowLeft: typeof import('~icons/ic/baseline-keyboard-double-arrow-left')['default']
    ...
    MaterialSymbolsMenuRounded: typeof import('~icons/material-symbols/menu-rounded')['default']
