...
<template>
  ...
  >
    ...
    <div class="h-full w-full progress-bar flex" style="align-self: stretch; border-radius: 9999px; overflow: hidden">
      <div style="align-self: stretch; background-color: #3366ff" :style="{ width: `${percentage}%` }"></div>
      <div style="align-self: stretch; background-color: #e5e5e5" :style="{ width: `${100 - percentage}%` }"></div>
