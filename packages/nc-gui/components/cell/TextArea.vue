...
const emits = defineEmits(['update:modelValue', 'generate', 'close'])
...
const selfModified = ref(false)

const generate = () => {
  emits('generate')
  selfModified.value = false
}

if (props.isAi) {
  watch(vModel, () => {
    if (props.aiMeta?.value !== vModel.value) {
      selfModified.value = true
    }
  })
}
...
<template>
  <div>
    ...
    >
      ...
      <div
        v-else-if="isRichMode || props.isAi"
    ...
    >
      ...
      >
        ...
        >
          ...
          <template v-else-if="props.isAi">
            <div class="flex items-center text-xs gap-1">
              <span class="text-purple-500">Generated by AI</span>
              <span v-if="selfModified" class="text-green-600"> Edited by you </span>
            ...
            <div class="flex items-center gap-1 mr-4">
              <NcButton type="primary" class="!bg-purple-400 hover:!bg-purple-600 !text-white" size="small" @click="generate">
                <div class="flex items-center gap-2">
                  <GeneralLoader v-if="aiLoading" class="!text-white" />
                  <GeneralIcon v-else icon="refresh" />
        ...
        <div v-if="props.isAi && props.aiMeta?.isStale">
          <div class="flex items-center p-4 bg-purple-100 text-purple-700 gap-4">
            <GeneralIcon icon="warning" class="text-purple-500 text-xl" />
            <div class="flex flex-col">
              <div class="font-bold">Record Data Updated</div>
        ...
        <div v-if="!isRichMode" class="p-3 pb-0 h-full">
          <a-textarea
            ...
            :style="{ resize: 'both' }"
            :disabled="readOnly || (props.isAi && aiLoading)"
