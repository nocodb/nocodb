      ...
      >
        ...
        >
          ...
          <template v-if="props.isAi && !isEditColumn">
            <div class="flex items-center text-small leading-[18px] gap-1">
              <span class="text-nc-content-purple-dark">Generated by AI</span>
              <span v-if="isAiEdited" class="text-nc-content-green-dark"> Edited by you </span>
