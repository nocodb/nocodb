...
<template>
  <a-drawer v-model:visible="value" class="nc-features-drawer" :mask="false" width="536px" :closable="false">
    <div class="flex flex-col h-full">
      <div class="flex items-center gap-3 p-2 !pl-4 border-b-1 border-gray-200">
        <component :is="iconMap.bulb" class="text-gray-500 h-5 w-5" @click="handleClick" />
