              ...
              <div class="nc-form-section-body">
                ...
                <template v-else-if="formState.dataSource.client === ClientType.D1">
                  <div class="flex items-center gap-2 text-xs text-warning">
                    ...
                    <span
                      >Cloudflare D1 supports read/write access and atomic batches for precompiled writes. Interactive transaction
                      blocks and DDL rollback remain best-effort.</span
                    >
                  </div>
                </template>
