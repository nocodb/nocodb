...
<template>
  <a-modal
    ...
    :closable="false"
    :width="templateEditorModal && importState.parserConfig.autoSelectFieldTypes ? '640px' : '448px'"
    class="!top-[12.5vh]"
    ...
    >
      ...
      >
        <TemplateEditor
          ...
          :auto-detect-field-types="importState.parserConfig.autoSelectFieldTypes"
