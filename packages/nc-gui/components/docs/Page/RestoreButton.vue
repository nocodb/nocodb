...
<template>
  <a-button type="text" class="!border-1 !border-gray-100 !rounded-md !px-3 mr-2" @click="isVisible = true">
  ...
  <a-modal v-model:visible="isVisible" :footer="null" centered :closable="isRestoring">
    <div class="flex flex-col gap-y-6 mx-2">
      ...
      <div class="flex flex-row gap-x-2">
        <a-button type="text" class="!rounded-sm" :disabled="isRestoring" @click="isVisible = false">Cancel</a-button>
        <a-button type="primary" class="!rounded-sm" :loading="isRestoring" @click="onRestore">Restore</a-button>
      </div>
    </div>
  </a-modal>
</template>
