...
<template>
  ...
  >
    <div class="relative">
      ...
      <img v-if="!appInfo?.company" :width="size" :height="size" alt="NocoDB" src="~/assets/img/icons/256x256.png" />
      <img v-else :width="size" :height="size" alt="Logo" :src="appInfo.company?.logo" />
