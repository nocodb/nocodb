...
<template>
  <div v-if="visibility !== 'hidden'" class="flex flex-col justify-center h-full">
    <div
      class="flex flex-row items-center gap-x-1.5 bg-primary text-white hover:bg-opacity-80 py-1 px-2.5 rounded-md cursor-pointer !pl-3"
      :class="{
