...
<template>
  <div class="px-3 py-2">
    <div
      class="nc-share-url-block flex items-center h-8 pr-1 pl-3 bg-nc-bg-default border-1 border-nc-border-gray-medium rounded-md hover:border-nc-border-gray-dark transition-colors"
    >
      ...
      <NcButton
        ...
        class="!h-6 !px-2 !text-bodySm !font-medium"
        @click="onCopy"
      >
