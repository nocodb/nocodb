...
function getDayIndex(date: dayjs.Dayjs) {
...
function calculateHourIndices(dayIndex: number, startDate: dayjs.Dayjs, endDate: dayjs.Dayjs) {
...
function calculateNewRow(event: MouseEvent, updateSideBar?: boolean): {
  newRow: Row | null
