          ...
          <div class="h-full flex">
            ...
            <div class="h-full w-1/2 border-r-1 border-r-nc-border-gray-medium">
              ...
              >
                ...
                <a-form-item class="!mb-0 !mt-7">
                  <div class="space-y-2">
                  <div class="font-bold">Allow AI to access the Internet</div>
                    <div class="text-small leading-[18px] flex gap-2 items-center text-nc-content-gray-subtle2">
                    If you want to allow AI to access the Internet, you can enable this option.
                  </div>
                  <NcSwitch v-model:checked="vModel.meta.allow_internet_access" />
                  </div>
                </a-form-item>
