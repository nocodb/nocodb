...
const snippet = computed(
  () =>
    new HTTPSnippet({
      method: 'GET',
      headers: [
        { name: 'xc-token', value: '<CREATE YOUR API TOKEN FROM : https://hostname.com/#/account/tokens>', comment: 'API token' },
      ],
      url: apiUrl.value,
      queryString: [
...
const api = new Api({
  ...
  headers: {
    "xc-token": "<CREATE YOUR API TOKEN FROM : https://hostname.com/#/account/tokens>"
  }
})
