...
import { type AttachmentType, type AuditType, checkboxIconListMap, isAIPromptCol, ratingIconListMap } from 'nocodb-sdk'
    ...
    <div class="flex items-center gap-1 !text-nc-content-gray-subtle2 text-xs font-weight-500 nc-audit-mini-item-header">
      ...
      <NcTooltip
        v-if="
          ...
          (!ncIsObject(newData[columnKey]) || !newData[columnKey]?.lastModifiedBy)
        "
        class="truncate text-xs text-nc-content-purple-medium"
        show-on-truncate-only
      >
        <template #title> Generated by AI </template>
