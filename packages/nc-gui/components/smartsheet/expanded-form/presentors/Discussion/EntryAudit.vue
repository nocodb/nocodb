    ...
    <template v-else>
      <div class="relative mb-2">
        ...
        <div class="text-sm mb-1 ml-6.5">
          changed
          <span class="text-xs border-1 border-gray-300 rounded-md px-1 py-0.25 bg-gray-200 inline-flex items-center gap-1 ml-1 mr-3">
      ...
      <div class="relative mb-2">
        ...
        <div class="text-sm mb-1 ml-6.5">
          ...
          <span class="text-xs border-1 border-gray-300 rounded-md px-1 py-0.25 bg-blue-200 inline-flex items-center gap-1 line-through">
            Open
          </span>
