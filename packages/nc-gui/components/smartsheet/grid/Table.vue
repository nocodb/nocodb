...
import { UITypes, ViewTypes, isAIPromptCol, isAutoGeneratedColumn, isLinksOrLTAR, isSystemColumn, isVirtualCol } from 'nocodb-sdk'
...
const isAddingEmptyRowAllowed = computed(
  () => !isView && hasEditPermission.value && !isSqlView.value && !isPublicView.value && !meta.value?.mm,
)
