...
<template>
  <NcMenu variant="small">
    <NcMenuItem
      ...
      @click="setSelectedTemplate(null); onNewRecordToGridClick(path ?? [])"
    >
    ...
    <NcMenuItem v-e="['c:row:add:form']" class="nc-new-record-with-form group" @click="setSelectedTemplate(null); onNewRecordToFormClick(path ?? [])">
