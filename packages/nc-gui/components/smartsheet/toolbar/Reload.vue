...
<template>
  <NcTooltip placement="bottom">
    ...
    <div
      class="flex ml-1 items-center justify-center select-none cursor-pointer text-gray-500 w-5.5 h-5.5 hover:(bg-[var(--topbar-bg-dark-color,#F4F4F5)] text-black) rounded"
    >
      <component
        :is="iconMap.reload"
