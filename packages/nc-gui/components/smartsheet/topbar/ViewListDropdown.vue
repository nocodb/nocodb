          ...
          <div class="overflow-hidden mb-2">
            <a-menu class="nc-viewlist-menu">
              <a-sub-menu popup-class-name="nc-viewlist-submenu-popup" :popup-offset="[8, -2]">
                ...
                <a-menu-item v-if="isEeUI && isFeatureEnabled(FEATURE_FLAG.TIMELINE)" data-testid="topbar-view-create-timeline" @click="showUpgradeToUseTimelineView({ successCallback: () => onOpenModal({ type: ViewTypes.TIMELINE }) })">
                  <div class="nc-viewlist-submenu-popup-item">
