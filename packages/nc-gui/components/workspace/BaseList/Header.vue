...
<template>
  <div class="nc-base-list-header flex items-center gap-2">
    ...
    <span class="hidden md:inline text-xs font-medium tracking-wide text-nc-content-gray-muted flex-1">
      <slot name="label">
        {{ $t('objects.projects') }} ({{ baseCount }})
      </slot>
    </span>
