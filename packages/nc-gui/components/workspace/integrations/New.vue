...
const { pageMode, IntegrationsPageMode, integrationType, activeIntegration, categories, activeCategory } = useIntegrationsPage()
</script>
...
<template>
  <div class="flex flex-col nc-workspace-settings-integrations-new">
    ...
    <div class="panel-view">
      ...
      <WorkspaceIntegrationsFormsPostgreSql v-if="activeIntegration.type === integrationType.PostgreSQL" />
      <WorkspaceIntegrationsFormsMySql v-else-if="activeIntegration.type === integrationType.MySQL" />
    </div>
  </div>
</template>
