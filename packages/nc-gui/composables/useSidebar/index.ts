...
const leftSidebar = createSharedComposable(() => createSidebar('nc-left-sidebar'))

const rightSidebar = createSharedComposable(() => createSidebar('nc-right-sidebar', { useStorage: true }))
