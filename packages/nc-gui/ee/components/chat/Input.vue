  ...
  <div class="nc-chat-input px-4 py-3">
    ...
    >
      ...
      <textarea
        ...
        :disabled="disabled"
        class="nc-chat-textarea w-full resize-none rounded-lg px-3 pt-2.5 pb-10 text-body bg-transparent text-nc-content-gray-emphasis placeholder:text-nc-content-gray-subtle nc-scrollbar-thin"
        rows="2"
