      ...
      <template #overlay>
        <a-menu class="!py-0 rounded text-sm">
          <a-menu-item-group class="!px-0 !mx-0">
            ...
            <a-menu-item key="table-magic" @click="openTableCreateMagicDialog(base.sources[baseIndex].id)">
              <div class="color-transition nc-base-menu-item group">
                <GeneralIcon icon="magic1" class="group-hover:text-accent" />
                Create table
              </div>
            </a-menu-item>
            <a-menu-item key="schema-magic" @click="openSchemaMagicDialog(base.sources[baseIndex].id)">
              <div class="color-transition nc-base-menu-item group">
                <GeneralIcon icon="magic1" class="group-hover:text-accent" />
                Create schema
              </div>
          ...
          <a-menu-item-group :title="$t('title.quickImportFrom')" class="!px-0 !mx-0">
            <a-menu-item
              ...
              @click="openAirtableImportDialog(base.id, base.sources[baseIndex].id)"
            >
              <div class="color-transition nc-base-menu-item group">
            ...
            <a-menu-item
              ...
              @click="openQuickImportDialog('csv', base.sources[baseIndex].id)"
            >
              <div class="color-transition nc-base-menu-item group">
            ...
            <a-menu-item
              ...
              @click="openQuickImportDialog('json', base.sources[baseIndex].id)"
            >
              <div class="color-transition nc-base-menu-item group">
