    ...
    >
      <template #title>
        <div class="flex flex-col gap-3">
          <div>
            <div class="text-[10px] leading-[14px] text-nc-content-brand-hover dark:text-nc-content-gray-muted uppercase mb-1">{{ $t('labels.scriptName') }}</div>
          ...
          >
            <template #default="{ isOpen }">
              ...
              >
                ...
                <GeneralIcon
                  :class="activeAutomationId === vModel.id ? '!text-nc-brand-600 opacity-85' : '!text-nc-gray-600 opacity-75'"
