...
import { Form, computed, nextTick, onMounted, ref, useBase, useTable, useVModel, validateTableName } from '#imports'
...
const { table, createSchemaMagic, generateUniqueTitle, tables, base } = useTable(async () => {
  await loadTables()
