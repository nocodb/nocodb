    ...
    <div class="flex flex-col mb-5 gap-1">
      <NcDropdown v-model:visible="isDropdownActive" class="mt-2">
        <div
          ...
          :class="{
            '!border-nc-border-brand !shadow-selected': isDropdownActive,
          }"
        >
            ...
            <template #listItem="{ option }">
              <div class="flex gap-2 w-full items-center" @click="selectWorkspace(option)">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <GeneralIcon v-if="option.id === selectedWorkspace?.id" class="text-nc-content-brand w-4 h-4" icon="ncCheck" />
                </div>
              </div>
            </template>
          </NcList>
