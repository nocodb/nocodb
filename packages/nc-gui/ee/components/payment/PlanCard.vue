...
<template>
  <div class="nc-border-gray-medium p-4 shadow-default rounded-lg w-[300px] flex flex-col gap-2">
    ...
    <NcButton v-if="activePlan === plan.title" type="ghost" size="medium" class="w-full !text-black" disabled>
    ...
    <NcButton v-else type="primary" size="medium" class="w-full" @click="onSelectPlan(plan)">
      <div class="flex items-center justify-center gap-1">Select Plan</div>
    </NcButton>
