...
const { isRecordLimitReached, isStorageLimitReached, gracePeriodDaysLeft, navigateToBilling, isWsOwner } = useEeConfig()
</script>
...
<template>
  ...
  >
    <NcButton @click="navigateToBilling()" class="nc-upgrade-sidebar-banner w-full !h-auto">
