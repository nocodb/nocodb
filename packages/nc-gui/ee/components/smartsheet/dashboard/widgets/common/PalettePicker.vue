...
<template>
  <NcSelect v-model:value="vModel" class="nc-palette-select" dropdown-class-name="nc-palette-select-dropdown" @change="onChange">
    <a-select-option v-for="opt in CHART_PALETTE_OPTIONS" :key="opt.value" :value="opt.value" :label="paletteLabel(opt.value)">
