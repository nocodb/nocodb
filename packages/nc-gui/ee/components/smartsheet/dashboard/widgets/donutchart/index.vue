...
const { chartOption } = useDashboardPieChartOption(widgetRef, widgetData, { isDonut: true })
...
<template>
  <div class="nc-donut-chart-widget h-full w-full flex flex-col relative bg-nc-bg-default !rounded-xl">
