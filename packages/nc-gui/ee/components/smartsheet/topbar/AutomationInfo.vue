    ...
    <template v-if="!isMobileMode">
      <SmartsheetTopbarProjectListDropdown is-automation>
        <template #default="{ isOpen }">
          <div
            class="rounded-lg h-8 px-2 text-nc-content-gray-subtle font-weight-500 hover:(bg-nc-bg-gray-light text-nc-content-gray-emphasis) flex items-center gap-1 cursor-pointer max-w-1/3"
            :class="{
