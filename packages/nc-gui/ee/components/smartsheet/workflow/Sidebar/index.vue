...
const { selectedNode, selectedNodeId, activeTab } = useWorkflowOrThrow()
</script>

<template>
  <div class="border-l-1 node-sidebar w-95 sidebar-config border-nc-border-gray-medium bg-nc-bg-default">
