...
const handleClick = () => {
  if (showEEFeatures.value && !isEEFeatureBlocked.value) return
...
<template>
  <NcDropdown v-if="hasAccess" v-model:visible="isVisibleCreateBase" :disabled="!showEEFeatures || isEEFeatureBlocked">
    <NcButton
      v-e="['c:base:create']"
      :type="type"
