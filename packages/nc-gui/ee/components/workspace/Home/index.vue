...
<template>
  <div class="h-full flex flex-col nc-workspace-home bg-white dark:bg-nc-bg-default">
    <!-- Top bar: 2 cols on < 1024px (search right), 3 equal cols on >= 1024px (search centered) -->
    <div class="grid grid-cols-[1fr_auto] lg:grid-cols-3 items-center px-2 h-[var(--topbar-height)] flex-none border-b-1 border-nc-border-gray-medium">
      <!-- Left -->
      ...
      <!-- Right spacer (only on md+ for 3-col centering) -->
