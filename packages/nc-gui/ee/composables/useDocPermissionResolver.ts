import type { DocumentType, PermissionType } from 'nocodb-sdk'
import { getPermissionOptionValue, PermissionEntity, PermissionGrantedType, type PermissionKey, type PermissionRole } from 'nocodb-sdk'
 ...
 */
export function useDocPermissionResolver(
  permissions: Ref<PermissionType[] | undefined>,
  activeDocuments: Ref<DocumentType[]>,
) {
