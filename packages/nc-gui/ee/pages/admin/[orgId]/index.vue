          ...
          <div class="h-full bg-white nc-user-sidebar fixed">
            ...
            >
              ...
              <div class="text-sm ml-4 p-2 mt-3 flex justify-between gap-2">
                <div v-if="org" class="font-weight-bold">
                  {{ org.title }}
                </div>
              ...
              <NcMenuItem
                ...
                class="item"
                :class="{
                  active: $route.params.page === '' || !$route.params.page,
                }"
              ...
              <NcMenuItem
                key="bases"
                :class="{
                  active: $route.params.page === 'bases',
                }"
                class="item"
                @click="navigateTo(`/admin/${$route.params.orgId}/bases`)"
              >
                <div class="flex items-center space-x-2">
                  <GeneralIcon class="!h-3.5 !w-3.5" icon="database" />
