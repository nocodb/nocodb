        ...
        <div>
          ...
          <div v-if="sharedFormView.subheading">
            <LazyCellRichText
              ...
              class="font-medium text-base text-nc-content-gray-muted dark:text-slate-300 !h-auto mb-4 -ml-1"
              is-form-field
              read-only
              sync-value-change
            />
        ...
        <template v-else-if="submitted">
          <div class="flex justify-center">
            <div v-if="sharedFormView" class="w-full">
              ...
              >
                <p v-if="sharedFormView?.show_blank_form" class="text-sm text-nc-content-gray-muted dark:text-slate-300 m-0">
...
:deep(.nc-cell .nc-action-icon) {
  @apply !text-nc-content-inverted-primary !bg-nc-bg-default/50 !p-1 !text-xs !w-7 !h-7 !flex !items-center !justify-center !cursor-pointer !hover: !bg-nc-bg-default !hover:!text-nc-content-inverted-primary !transition;
}
