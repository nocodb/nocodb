Upload data from CSV extension for NocoDB allows users to upload CSV files into existing tables. Users can map columns from their CSV files to the corresponding columns in NocoDB, making data management easier.
</br></br>
...
<a href="https://nocodb.com/docs/product-docs/extensions/upload-data-from-csv" target="_blank" rel="noopener noreferrer" class="!no-underline !hover:underline inline-flex items-center gap-2 ">
    Learn more 
...
<div class="flex gap-5">
    <img src="csv-import-ee/assets/upload-file.png" class="w-[calc(50%_-_10px)] object-contain rounded-xl"/>
    <img src="csv-import-ee/assets/recent-imports.png" class="w-[calc(50%_-_10px)] object-contain rounded-xl"/>
</div>
<br/>
<div>
 <img src="csv-import-ee/assets/upload-csv-modal.png" width="100%" class="object-contain rounded-xl"/>
</div>
