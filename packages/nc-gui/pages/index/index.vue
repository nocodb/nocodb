...
<template>
  <NuxtLayout>
    <div class="min-h-[calc(100vh_-_var(--header-height))] bg-primary bg-opacity-5">
      <div class="flex flex-wrap justify-center xl:flex-nowrap gap-6 py-6 px-4 md:(px-12 pt-65px)">
        <div class="hidden xl:(flex) self-end">
