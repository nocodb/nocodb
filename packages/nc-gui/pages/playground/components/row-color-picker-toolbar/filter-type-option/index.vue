  ...
  <div class="bg-nc-bg-gray-light">
    <a-card>
      ...
      <div>
        ...
        <NcButton type="secondary" size="small" @click="rowColoringMode = null">
          Clear
        </NcButton>
      </div>
    </a-card>
    <SmartsheetToolbarRowColorFilterTypeOption v-model:row-coloring-mode="rowColoringMode">
      <template #filter>
        <div class="bg-nc-bg-default animate-animated animate-fadeIn" style="animation-duration: 0.3s">
          This is filter panel <NcButton type="secondary" size="small" @click="rowColoringMode = null">
            Clear
          </NcButton>
        </div>
      </template>
      ...
      <template #select>
        <div class="bg-nc-bg-default animate-animated animate-fadeIn" style="animation-duration: 0.3s">
          This is select panel <NcButton type="secondary" size="small" @click="rowColoringMode = null">
            Clear
          </NcButton>
        </div>
      </template>
