...
export const themeV4Colorsl = {
  base: {
    white: 'rgba(var(--rgb-color-base-white), var(--tw-bg-opacity))',
    black: 'rgba(var(--rgb-color-base-black), var(--tw-bg-opacity))',
  },
  brand: {
    inverted: 'rgba(var(--rgb-color-brand-inverted), var(--tw-bg-opacity))',
    20: 'rgba(var(--rgb-color-brand-20), var(--tw-bg-opacity))',
    50: 'rgba(var(--rgb-color-brand-50), var(--tw-bg-opacity))',
    100: 'rgba(var(--rgb-color-brand-100), var(--tw-bg-opacity))',
    200: 'rgba(var(--rgb-color-brand-200), var(--tw-bg-opacity))',
    300: 'rgba(var(--rgb-color-brand-300), var(--tw-bg-opacity))',
    400: 'rgba(var(--rgb-color-brand-400), var(--tw-bg-opacity))',
    500: 'rgba(var(--rgb-color-brand-500), var(--tw-bg-opacity))',
    600: 'rgba(var(--rgb-color-brand-600), var(--tw-bg-opacity))',
    700: 'rgba(var(--rgb-color-brand-700), var(--tw-bg-opacity))',
    800: 'rgba(var(--rgb-color-brand-800), var(--tw-bg-opacity))',
    900: 'rgba(var(--rgb-color-brand-900), var(--tw-bg-opacity))',
  },
  gray: {
    10: '#FCFCFC',
    50: 'rgba(var(--rgb-color-gray-50), var(--tw-bg-opacity))',
    100: 'rgba(var(--rgb-color-gray-100), var(--tw-bg-opacity))',
    200: 'rgba(var(--rgb-color-gray-200), var(--tw-bg-opacity))',
    300: 'rgba(var(--rgb-color-gray-300), var(--tw-bg-opacity))',
    400: 'rgba(var(--rgb-color-gray-400), var(--tw-bg-opacity))',
    500: 'rgba(var(--rgb-color-gray-500), var(--tw-bg-opacity))',
    600: 'rgba(var(--rgb-color-gray-600), var(--tw-bg-opacity))',
    700: 'rgba(var(--rgb-color-gray-700), var(--tw-bg-opacity))',
    800: 'rgba(var(--rgb-color-gray-800), var(--tw-bg-opacity))',
    900: 'rgba(var(--rgb-color-gray-900), var(--tw-bg-opacity))',
  },
  red: {
    50: 'rgba(var(--rgb-color-red-50), var(--tw-bg-opacity))',
    100: 'rgba(var(--rgb-color-red-100), var(--tw-bg-opacity))',
    200: 'rgba(var(--rgb-color-red-200), var(--tw-bg-opacity))',
    300: 'rgba(var(--rgb-color-red-300), var(--tw-bg-opacity))',
    400: 'rgba(var(--rgb-color-red-400), var(--tw-bg-opacity))',
    500: 'rgba(var(--rgb-color-red-500), var(--tw-bg-opacity))',
    600: 'rgba(var(--rgb-color-red-600), var(--tw-bg-opacity))',
    700: 'rgba(var(--rgb-color-red-700), var(--tw-bg-opacity))',
    800: 'rgba(var(--rgb-color-red-800), var(--tw-bg-opacity))',
    900: 'rgba(var(--rgb-color-red-900), var(--tw-bg-opacity))',
  },
  pink: {
    50: 'rgba(var(--rgb-color-pink-50), var(--tw-bg-opacity))',
    100: 'rgba(var(--rgb-color-pink-100), var(--tw-bg-opacity))',
    200: 'rgba(var(--rgb-color-pink-200), var(--tw-bg-opacity))',
    300: 'rgba(var(--rgb-color-pink-300), var(--tw-bg-opacity))',
    400: 'rgba(var(--rgb-color-pink-400), var(--tw-bg-opacity))',
    500: 'rgba(var(--rgb-color-pink-500), var(--tw-bg-opacity))',
    600: 'rgba(var(--rgb-color-pink-600), var(--tw-bg-opacity))',
    700: 'rgba(var(--rgb-color-pink-700), var(--tw-bg-opacity))',
    800: 'rgba(var(--rgb-color-pink-800), var(--tw-bg-opacity))',
    900: 'rgba(var(--rgb-color-pink-900), var(--tw-bg-opacity))',
  },
  orange: {
    50: 'rgba(var(--rgb-color-orange-50), var(--tw-bg-opacity))',
    100: 'rgba(var(--rgb-color-orange-100), var(--tw-bg-opacity))',
    200: 'rgba(var(--rgb-color-orange-200), var(--tw-bg-opacity))',
    300: 'rgba(var(--rgb-color-orange-300), var(--tw-bg-opacity))',
    400: 'rgba(var(--rgb-color-orange-400), var(--tw-bg-opacity))',
    500: 'rgba(var(--rgb-color-orange-500), var(--tw-bg-opacity))',
    600: 'rgba(var(--rgb-color-orange-600), var(--tw-bg-opacity))',
    700: 'rgba(var(--rgb-color-orange-700), var(--tw-bg-opacity))',
    800: 'rgba(var(--rgb-color-orange-800), var(--tw-bg-opacity))',
    900: 'rgba(var(--rgb-color-orange-900), var(--tw-bg-opacity))',
  },
  purple: {
    50: 'rgba(var(--rgb-color-purple-50), var(--tw-bg-opacity))',
    100: 'rgba(var(--rgb-color-purple-100), var(--tw-bg-opacity))',
    200: 'rgba(var(--rgb-color-purple-200), var(--tw-bg-opacity))',
    300: 'rgba(var(--rgb-color-purple-300), var(--tw-bg-opacity))',
    400: 'rgba(var(--rgb-color-purple-400), var(--tw-bg-opacity))',
    500: 'rgba(var(--rgb-color-purple-500), var(--tw-bg-opacity))',
    600: 'rgba(var(--rgb-color-purple-600), var(--tw-bg-opacity))',
    700: 'rgba(var(--rgb-color-purple-700), var(--tw-bg-opacity))',
    800: 'rgba(var(--rgb-color-purple-800), var(--tw-bg-opacity))',
    900: 'rgba(var(--rgb-color-purple-900), var(--tw-bg-opacity))',
  },
  blue: {
    50: 'rgba(var(--rgb-color-blue-50), var(--tw-bg-opacity))',
    100: 'rgba(var(--rgb-color-blue-100), var(--tw-bg-opacity))',
    200: 'rgba(var(--rgb-color-blue-200), var(--tw-bg-opacity))',
    300: 'rgba(var(--rgb-color-blue-300), var(--tw-bg-opacity))',
    400: 'rgba(var(--rgb-color-blue-400), var(--tw-bg-opacity))',
    500: 'rgba(var(--rgb-color-blue-500), var(--tw-bg-opacity))',
    600: 'rgba(var(--rgb-color-blue-600), var(--tw-bg-opacity))',
    700: 'rgba(var(--rgb-color-blue-700), var(--tw-bg-opacity))',
    800: 'rgba(var(--rgb-color-blue-800), var(--tw-bg-opacity))',
    900: 'rgba(var(--rgb-color-blue-900), var(--tw-bg-opacity))',
  },
  yellow: {
    50: 'rgba(var(--rgb-color-yellow-50), var(--tw-bg-opacity))',
    100: 'rgba(var(--rgb-color-yellow-100), var(--tw-bg-opacity))',
    200: 'rgba(var(--rgb-color-yellow-200), var(--tw-bg-opacity))',
    300: 'rgba(var(--rgb-color-yellow-300), var(--tw-bg-opacity))',
    400: 'rgba(var(--rgb-color-yellow-400), var(--tw-bg-opacity))',
    500: 'rgba(var(--rgb-color-yellow-500), var(--tw-bg-opacity))',
    600: 'rgba(var(--rgb-color-yellow-600), var(--tw-bg-opacity))',
    700: 'rgba(var(--rgb-color-yellow-700), var(--tw-bg-opacity))',
    800: 'rgba(var(--rgb-color-yellow-800), var(--tw-bg-opacity))',
    900: 'rgba(var(--rgb-color-yellow-900), var(--tw-bg-opacity))',
  },
  maroon: {
    50: 'rgba(var(--rgb-color-maroon-50), var(--tw-bg-opacity))',
    100: 'rgba(var(--rgb-color-maroon-100), var(--tw-bg-opacity))',
    200: 'rgba(var(--rgb-color-maroon-200), var(--tw-bg-opacity))',
    300: 'rgba(var(--rgb-color-maroon-300), var(--tw-bg-opacity))',
    400: 'rgba(var(--rgb-color-maroon-400), var(--tw-bg-opacity))',
    500: 'rgba(var(--rgb-color-maroon-500), var(--tw-bg-opacity))',
    600: 'rgba(var(--rgb-color-maroon-600), var(--tw-bg-opacity))',
    700: 'rgba(var(--rgb-color-maroon-700), var(--tw-bg-opacity))',
    800: 'rgba(var(--rgb-color-maroon-800), var(--tw-bg-opacity))',
    900: 'rgba(var(--rgb-color-maroon-900), var(--tw-bg-opacity))',
  },
  green: {
    50: 'rgba(var(--rgb-color-green-50), var(--tw-bg-opacity))',
    100: 'rgba(var(--rgb-color-green-100), var(--tw-bg-opacity))',
    200: 'rgba(var(--rgb-color-green-200), var(--tw-bg-opacity))',
    300: 'rgba(var(--rgb-color-green-300), var(--tw-bg-opacity))',
    400: 'rgba(var(--rgb-color-green-400), var(--tw-bg-opacity))',
    500: 'rgba(var(--rgb-color-green-500), var(--tw-bg-opacity))',
    600: 'rgba(var(--rgb-color-green-600), var(--tw-bg-opacity))',
    700: 'rgba(var(--rgb-color-green-700), var(--tw-bg-opacity))',
    800: 'rgba(var(--rgb-color-green-800), var(--tw-bg-opacity))',
    900: 'rgba(var(--rgb-color-green-900), var(--tw-bg-opacity))',
  },
}
