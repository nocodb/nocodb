  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'small': ['13px', '16px'],
        'small1': ['13px', '18px'],
        'heading1': ['64px', { lineHeight: '92px', fontWeight: 600, letterSpacing: '-2%' }],
        'heading2': ['40px', { lineHeight: '64px', fontWeight: 600, letterSpacing: '-2%' }],
        'heading3': ['24px', { lineHeight: '36px', fontWeight: 600, letterSpacing: '-2%' }],
        'sub-heading1': ['20px', { lineHeight: '32px', fontWeight: 600, letterSpacing: '-2%' }],
        'sub-heading2': ['16px', { lineHeight: '24px', fontWeight: 600, letterSpacing: '-2%' }],
        'body-lg': ['16px', { lineHeight: '28px', fontWeight: 400, letterSpacing: '-2%' }],
        'body-lg-bold': ['16px', { lineHeight: '28px', fontWeight: 600, letterSpacing: '-2%' }],
        'body': ['14px', { lineHeight: '24px', fontWeight: 400, letterSpacing: '0%' }],
        'body-bold': ['14px', { lineHeight: '24px', fontWeight: 600, letterSpacing: '0%' }],
        'body-default-sm': ['13px', { lineHeight: '18px', fontWeight: 400, letterSpacing: '0%' }],
        'body-default-sm-bold': ['13px', { lineHeight: '18px', fontWeight: 600, letterSpacing: '0%' }],
        'body-sm': ['12px', { lineHeight: '18px', fontWeight: 400, letterSpacing: '0%' }],
        'body-sm-bold': ['12px', { lineHeight: '18px', fontWeight: 600, letterSpacing: '0%' }],
        'caption': ['14px', { lineHeight: '20px', fontWeight: 400, letterSpacing: '0%' }],
        'caption-bold': ['14px', { lineHeight: '20px', fontWeight: 600, letterSpacing: '0%' }],
        'caption-sm': ['12px', { lineHeight: '14px', fontWeight: 400, letterSpacing: '0%' }],
        'caption-sm-bold': ['12px', { lineHeight: '14px', fontWeight: 600, letterSpacing: '0%' }],
        'caption-xs': ['10px', { lineHeight: '14px', fontWeight: 400, letterSpacing: '0%' }],
        'caption-xs-bold': ['10px', { lineHeight: '14px', fontWeight: 600, letterSpacing: '0%' }],
        'caption-dropdown-default': ['13px', { lineHeight: '20px', fontWeight: 550, letterSpacing: '0%' }],
        'sidebar-default': ['14px', { lineHeight: '20px', fontWeight: 550, letterSpacing: '0%' }],
        'sidebar-selected': ['14px', { lineHeight: '20px', fontWeight: 550, letterSpacing: '0%' }],
      },
      fontWeight: {
        thin: 150,
        extraLight: 250,
