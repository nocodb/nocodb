...
:sandbox{src="https://codesandbox.io/embed/vigorous-firefly-80kq5?hidenavigation=1&theme=dark"}

### Docker deploying with one command

::div{style="display: flex; justify-content: center;"}
  :video-player{src="https://www.youtube.com/watch?v=K-UEecQyiOk" style="width: 100%; padding-top: min(500px,56%);"}
::

### Using NPX

::div{style="display: flex; justify-content: center;"}
  :video-player{src="https://www.youtube.com/watch?v=v6Nn75P1p7I" style="width: 100%; padding-top: min(500px,56%);"}
::
