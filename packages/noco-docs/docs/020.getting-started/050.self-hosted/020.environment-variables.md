---
title: 'Environment variables' description: 'Environment Variables for NocoDB!'
hide_table_of_contents: true tags: ['Open Source']
...
- These variables are used to configure frontend settings in NocoDB.
...
- This setting controls the caching mechanism in NocoDB using Redis.
...
- These variables are used to configure various aspects of NocoDB's behavior and limitations.
