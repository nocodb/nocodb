...
:::warning
NocoDB doesn't recommend enabling schema editing option. Use with caution, as changes made to the schema can impact the data integrity and functionality of the connected data source.
:::
