...
export const SCHEMA_FILE_STORAGE: SyncSchema = {
  [TARGET_TABLES.CRM_ACCOUNT]: {
    title: TARGET_TABLES_META.crm_account.label,
    columns: [
  ...
  [TARGET_TABLES.CRM_CONTACT]: {
    title: TARGET_TABLES_META.crm_contact.label,
    columns: [
  ...
  [TARGET_TABLES.CRM_LEAD]: {
    title: TARGET_TABLES_META.crm_lead.label,
    columns: [
      { title: 'Owner', uidt: UITypes.SingleLineText },
    ...
    relations: [
      {
        columnTitle: 'Converted Account',
        relatedTable: TARGET_TABLES.CRM_ACCOUNT,
        relatedTableColumnTitle: 'Leads'
      },
      {
        columnTitle: 'Converted Contact',
  ...
  [TARGET_TABLES.CRM_REMOTE_FIELD_CLASS]: {
    title: TARGET_TABLES_META.crm_remote_field_class.label,
    columns: [
      { title: 'Display Name', uidt: UITypes.SingleLineText },
      { title: 'Remote Key Name', uidt: UITypes.SingleLineText },
      { title: 'Description', uidt: UITypes.SingleLineText },
      { title: 'Is Custom', uidt: UITypes.Checkbox },
      { title: 'Is Common Model Field', uidt: UITypes.Checkbox },
      { title: 'Is Required', uidt: UITypes.Checkbox },
      { title: 'Field Type', uidt: UITypes.SingleSelect },
      { title: 'Field Format', uidt: UITypes.SingleLineText },
      { title: 'Field Choices', uidt: UITypes.SingleSelect },
      { title: 'Item Schema', uidt: UITypes.SingleLineText },
    ],
    relations: [],
  },

  [TARGET_TABLES.CRM_STAGE]: {
    title: TARGET_TABLES_META.crm_stage.label,
    columns: [
      { title: 'Name', uidt: UITypes.SingleLineText },
      { title: 'Remote Fields', uidt: UITypes.SingleLineText },
    ],
  ...
  [TARGET_TABLES.CRM_USER]: {
    title: TARGET_TABLES_META.crm_user.label,
    columns: [
      { title: 'Name', uidt: UITypes.SingleLineText },
