...
export const clientSecret = process.env.INTEGRATION_AUTH_BITBUCKET_CLIENT_SECRET;
...
export const scopes = ['repository', 'repository:write', 'pullrequest', 'pullrequest:write', 'issue', 'issue:write', 'account'];
