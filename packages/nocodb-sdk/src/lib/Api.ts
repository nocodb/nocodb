 ...
 */
    ...
    /**
     * @description Sync missed events for a base
     * 
     * @tags Base
     * @name SyncEvents
     * @summary Sync missed realtime events
     * @request POST:/api/v2/sync-events
     * @response `200` `object[]` OK
     */
    syncEvents: (
      data: {
