 ...
 *
 * Source: tweakcn's `utils/theme-presets.ts`, fetched 2026-06-25 at commit
 * 26028ebcc1229f1b8e6f3f41220538a9faedc541. Only the keys in
 * `APP_THEME_TOKEN_KEYS` are kept (fonts / shadows / spacing / letter-spacing
 * dropped for v1). Keys are the tweakcn slugs verbatim and are stable — they are
 * persisted in `app.meta.theme.preset`.
 */
