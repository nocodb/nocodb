...
/** How much production data an environment instance copies at open time. */
export type EnvironmentDataMode = 'full' | 'empty' | 'window';
...
export const DEFAULT_ENVIRONMENTS: EnvironmentType[] = [
  ...
  },
  {
    ...
    title: 'Staging',
    description:
      'Pick this while building apps or opening an environment instance, to test against non-production data.',
    color: '#FA8231', // orange-500
    order: -1,
    is_locked: true,
  },
];
