...
/**
 * Layouts that can be shared publicly (read-only, page-level uuid) —
 * mirrors Airtable's unsupported-layouts list (no overview/form/record
 * layouts on public pages).
 */
export const INTERFACE_PUBLIC_SHAREABLE_LAYOUTS: readonly InterfacePageLayoutTypes[] =
  [InterfacePageLayoutTypes.TABLE, InterfacePageLayoutTypes.DASHBOARD] as const;
