...
export class TeamsV3Controller {
  ...
  @Get('/api/v3/meta/:workspaceOrOrgId/teams')
  ...
  @Get('/api/v3/meta/:workspaceOrOrgId/teams/:teamId')
  ...
  @Post('/api/v3/meta/:workspaceOrOrgId/teams')
  @HttpCode(200)
  ...
  @Patch('/api/v3/meta/:workspaceOrOrgId/teams/:teamId')
  ...
  @Delete('/api/v3/meta/:workspaceOrOrgId/teams/:teamId')
  ...
  @Post('/api/v3/meta/:workspaceOrOrgId/teams/:teamId/members')
  @HttpCode(200)
  ...
  @Delete('/api/v3/meta/:workspaceOrOrgId/teams/:teamId/members')
  ...
  @Patch('/api/v3/meta/:workspaceOrOrgId/teams/:teamId/members')
