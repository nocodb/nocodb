...
class BaseModelSqlv2 {
  ...
  public async findOne(
    ...
    if (Array.isArray(sorts) && sorts?.length) {
      await sortV2(this, sorts, qb, this.dbDriver);
  ...
  async groupBy(
    ...
    if (sorts) await sortV2(this, sorts, qb, this.dbDriver);
    applyPaginate(qb, rest);
    return await qb;
  }
  ...
  private async applySortAndFilter({
    ...
    await conditionV2(this, filter, qb, this.dbDriver);
    if (!sort) return;
    const sortObj = extractSortsObject(sort, childAliasColMap);
    if (sortObj) await sortV2(this, sortObj, qb, this.dbDriver);
  }
  ...
  public async getMmChildrenExcludedListCount(
    ...
    await conditionV2(this, filterObj, qb, this.dbDriver);
  ...
  async bulkUpdateAll(
    ...
    try {
      ...
      if (pkValues) {
        ...
        await conditionV2(this, conditionObj, qb, this.dbDriver);
  ...
  > {
    try {
      ...
      if (!args.ignoreViewFilterAndSort && this.viewId) {
        ...
        if (sorts?.['length']) await sortV2(this, sorts, qb, this.dbDriver);
      } else {
        await conditionV2(
          this,
          [
