...
> = {
  ...
  [UITypes.Number]: {
    ...
    [ClientType.D1]: NumberSqliteHandler,
  },
  [UITypes.Decimal]: {
    ...
    [ClientType.D1]: DecimalSqliteHandler,
  },
  [UITypes.Currency]: {
    ...
    [ClientType.D1]: CurrencySqliteHandler,
  },
  [UITypes.Percent]: {
    ...
    [ClientType.D1]: PercentSqliteHandler,
  },
  [UITypes.Duration]: {
  ...
  [UITypes.Rating]: {
    ...
    [ClientType.D1]: RatingSqliteHandler,
  },
  [UITypes.Colour]: {
  ...
  [UITypes.DateTime]: {
    ...
    [ClientType.D1]: DateTimeSQLiteHandler,
  },
  [UITypes.CreatedTime]: {
    [CLIENT_DEFAULT]: DateTimeGeneralHandler,
    [ClientType.PG]: DateTimePGHandler,
  ...
  [UITypes.User]: {
    ...
    [ClientType.D1]: UserSqliteHandler,
  },
  [UITypes.CreatedBy]: {
    [CLIENT_DEFAULT]: ComputedFieldHandler,
  },
