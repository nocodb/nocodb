...
/**
 * Get a stable installation ID for this NocoDB instance.
 *
 ...
 * (different databases) get distinct installation IDs.
 *
 ...
 */
export async function getDbFingerprint(ncMeta = Noco.ncMeta): Promise<string> {
  try {
