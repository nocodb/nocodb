 ...
 * documentCommentReactionToggle, and documentCommentResolve.
 */
  ...
  implements InternalApiModule<InternalPOSTResponseType>
{
  ...
  operations = [
    ...
    'documentCommentResolve' as const,
  ];
  ...
  async handle(
    ...
    switch (operation) {
      ...
      case 'documentCommentResolve': {
        ...
        return await this.documentCommentsService.commentResolve(context, {
          commentId: payload.commentId,
          user: req.user,
          req,
        });
