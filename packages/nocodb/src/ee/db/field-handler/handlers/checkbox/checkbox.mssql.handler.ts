...
import { CheckboxMssqlHandler as CheckboxMssqlHandlerCE } from 'src/db/field-handler/handlers/checkbox/checkbox.mssql.handler';
...
export class CheckboxMssqlHandler extends CheckboxMssqlHandlerCE {
