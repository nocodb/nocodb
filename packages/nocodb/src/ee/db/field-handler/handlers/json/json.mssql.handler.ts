import { JsonMssqlHandler as JsonMssqlHandlerCE } from 'src/db/field-handler/handlers/json/json.mssql.handler';
 ...
 */
export class JsonMssqlHandler extends JsonMssqlHandlerCE {
