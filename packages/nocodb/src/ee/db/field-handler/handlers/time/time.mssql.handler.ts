import { TimeMssqlHandler as TimeMssqlHandlerCE } from 'src/db/field-handler/handlers/time/time.mssql.handler';
 ...
 */
export class TimeMssqlHandler extends TimeMssqlHandlerCE {
