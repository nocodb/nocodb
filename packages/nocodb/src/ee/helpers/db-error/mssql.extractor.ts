...
import { MssqlDBErrorExtractor as MssqlDBErrorExtractorCE } from 'src/helpers/db-error/mssql.extractor';
import type { Logger } from '@nestjs/common';
import type {
  DBErrorExtractResult,
  IClientDbErrorExtractor,
} from '~/helpers/db-error/utils';
import { DBError } from '~/helpers/db-error/utils';
 ...
 */
export class MssqlDBErrorExtractor
  extends MssqlDBErrorExtractorCE
  implements IClientDbErrorExtractor
{
  constructor(
