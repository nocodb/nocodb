...
import AiWorkflowNodes from '@noco-local-integrations/ai-workflow-nodes';
...
import GithubWorkflowNode from '@noco-local-integrations/github-workflow-node';
...
import HubspotCrmWorkflowNode from '@noco-local-integrations/hubspot-crm-workflow-node';
...
export default [
  ...(Array.isArray(AiWorkflowNodes) ? AiWorkflowNodes : [AiWorkflowNodes]),
