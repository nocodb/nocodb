...
import * as nc_052_deprecate_unused from './v3/nc_052_deprecate_unused';
...
export default class XcMigrationSourcev3 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_052_deprecate_unused':
        return nc_052_deprecate_unused;
    }
  }
}
