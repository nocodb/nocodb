  ...
  public static async baseList(orgId: string, ncMeta = Noco.ncMeta) {
    ...
    const bases = await ncMeta
      ...
      .select(
        ...
        `${MetaTable.PROJECT}.managed_app_master as managed_app_master`,
        `${MetaTable.PROJECT}.managed_app_id as managed_app_id`,
      ...
      .groupBy(
        ...
        `${MetaTable.PROJECT}.managed_app_master`,
        `${MetaTable.PROJECT}.managed_app_id`,
        `${MetaTable.WORKSPACE}.id`,
