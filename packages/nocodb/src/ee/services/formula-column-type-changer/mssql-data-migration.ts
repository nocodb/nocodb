...
import { MssqlDataMigration as MssqlDataMigrationCE } from 'src/services/formula-column-type-changer/mssql-data-migration';
...
export class MssqlDataMigration
  extends MssqlDataMigrationCE
  implements FormulaDataMigrationDriver
{
  constructor() {
    super();
