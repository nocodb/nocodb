      ...
      <Body className="bg-white">
        <ContentWrapper branding={branding}>
          ...
          <Text className="text-gray-600 text-center !my-6 text-sm">
            ...
            {inviterEmail}) has added your team{' '}
            <span className="font-bold text-gray-800">{teamTitle}</span> to base{' '}
            <span className="font-bold text-gray-800">{baseTitle}</span> with
            role <span className="font-bold text-gray-800">{roleLabel}</span>.
          </Text>
          <Button
