...
const rolePermissions:
  ...
  [ProjectRoles.EDITOR]: {
    include: {
      ...
      timelineViewCreate: true,
      timelineViewUpdate: true,
      ganttViewCreate: true,
      ganttViewUpdate: true,
      listViewCreate: true,
      listViewUpdate: true,
...
const permissionDescriptions: Record<string, string> = {
  ...
  ganttViewCreate: 'create gantt view',
  ...
  ganttColumnUpdate: 'update gantt columns',
