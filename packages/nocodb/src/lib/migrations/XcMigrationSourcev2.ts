...
import * as nc_024_add_views_sections from './v2/nc_024_add_views_sections';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_024_add_views_sections':
        return nc_024_add_views_sections;
    }
  }
}
