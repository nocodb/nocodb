...
export class MetaService {
  ...
  public async genNanoid(target: string) {
    ...
    const prefixMap: { [key: string]: string } = {
      ...
      [MetaTable.MANAGED_APP_TEAMS]: 'mat',
      [MetaTable.MARKETPLACE_PUBLISHERS]: 'mpub',
      [MetaTable.MARKETPLACE_CURATIONS]: 'mcur',
      [MetaTable.MARKETPLACE_REPORTS]: 'mrep',
      [MetaTable.APP_TEAMS]: 'apg',
      [MetaTable.BASE_ENVIRONMENTS]: 'bev',
      [MetaTable.ENVIRONMENT_CHANGELOG]: 'ecl',
      ...
      [MetaTable.COMPUTE_INSTANCES]: 'cpi',
      ...
      [MetaTable.APP_CONNECTION_SLOTS]: 'acs',
      [MetaTable.APP_ACTIONS]: 'act',
      [MetaTable.APP_ACTION_VERSIONS]: 'acv',
      [MetaTable.APP_VERSION_ACTIONS]: 'acp',
      [MetaTable.APP_VERSION_GRANTS]: 'agr',
      [MetaTable.APP_VERSION_PUBLIC_ROUTES]: 'apr',
      [MetaTable.APP_AGENT_SESSIONS]: 'ags',
      [MetaTable.APP_AGENT_MESSAGES]: 'agm',
    };
