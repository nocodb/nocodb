...
import * as nc_202603311200_scim_config_default_role from './v0/nc_202603311200_scim_config_default_role';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_202603311200_scim_config_default_role',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_202603311200_scim_config_default_role':
        return nc_202603311200_scim_config_default_role;
    }
  }
}
