...
import * as nc_202603300001_add_error_column_to_col_options from './v0/nc_202603300001_add_error_column_to_col_options';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_202603300001_add_error_column_to_col_options',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_202603300001_add_error_column_to_col_options':
        return nc_202603300001_add_error_column_to_col_options;
    }
  }
}
