...
import * as nc_202606021000_table_sync_soft_delete from './v0/nc_202606021000_table_sync_soft_delete';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_202606021000_table_sync_soft_delete',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_202606021000_table_sync_soft_delete':
        return nc_202606021000_table_sync_soft_delete;
    }
  }
}
