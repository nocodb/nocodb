...
import * as nc_202603070000_date_dependency from './v0/nc_202603070000_date_dependency';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_202603070000_date_dependency',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_202603070000_date_dependency':
        return nc_202603070000_date_dependency;
    }
  }
}
