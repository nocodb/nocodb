...
import * as nc_202603260001_trash_cleanup_due_at from './v0/nc_202603260001_trash_cleanup_due_at';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_202603260001_trash_cleanup_due_at',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_202603260001_trash_cleanup_due_at':
        return nc_202603260001_trash_cleanup_due_at;
    }
  }
}
