...
import * as nc_099_add_constraints_col_in_column_table from './v0/nc_099_add_constraints_col_in_column_table';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_099_add_constraints_col_in_column_table',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_099_add_constraints_col_in_column_table':
        return nc_099_add_constraints_col_in_column_table;
    }
  }
}
