...
import * as nc_202604290000_subscriber_unique_with_base_id from './v0/nc_202604290000_subscriber_unique_with_base_id';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_202604290000_subscriber_unique_with_base_id',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_202604290000_subscriber_unique_with_base_id':
        return nc_202604290000_subscriber_unique_with_base_id;
    }
  }
}
