...
import * as nc_202603060001_chat_session_meta from './v0/nc_202603060001_chat_session_meta';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_202603060001_chat_session_meta',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_202603060001_chat_session_meta':
        return nc_202603060001_chat_session_meta;
    }
  }
}
