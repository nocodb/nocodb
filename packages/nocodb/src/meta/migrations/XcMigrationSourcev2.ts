...
import * as nc_061_form_field_filter from '~/meta/migrations/v2/nc_061_form_field_filter';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_061_form_field_filter':
        return nc_061_form_field_filter;
    }
  }
}
