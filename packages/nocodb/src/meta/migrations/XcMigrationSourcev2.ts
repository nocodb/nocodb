...
import * as nc_073_audit_refactor from '~/meta/migrations/v2/nc_073_audit_refactor';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_073_audit_refactor':
        return nc_073_audit_refactor;
    }
  }
}
