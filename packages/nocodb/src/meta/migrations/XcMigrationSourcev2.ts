...
import * as nc_099_ltar_order_columns from '~/meta/migrations/v2/nc_099_ltar_order_columns';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_099_ltar_order_columns':
        return nc_099_ltar_order_columns;
    }
  }
}
