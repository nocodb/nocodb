...
import * as nc_088_dashboard_sharing from '~/meta/migrations/v2/nc_088_dashboard_sharing';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_088_dashboard_sharing':
        return nc_088_dashboard_sharing;
    }
  }
}
