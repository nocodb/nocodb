...
import * as nc_078_hook_trigger_fields from '~/meta/migrations/v2/nc_078_hook_trigger_fields';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_078_hook_trigger_fields':
        return nc_078_hook_trigger_fields;
    }
  }
}
