...
import * as nc_082_hook_trigger_fields from '~/meta/migrations/v2/nc_082_hook_trigger_fields';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_081_audit':
        return nc_081_audit;
      case 'nc_082_hook_trigger_fields':
        return nc_082_hook_trigger_fields;
    }
  }
}
