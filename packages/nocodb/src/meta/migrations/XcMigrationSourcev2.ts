...
import * as nc_084_missing_uuid_indexes from '~/meta/migrations/v2/nc_084_missing_uuid_indexes';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_084_missing_uuid_indexes':
        return nc_084_missing_uuid_indexes;
    }
  }
}
