...
import * as nc_078_deprecate_unused from '~/meta/migrations/v2/nc_078_deprecate_unused';
import * as nc_079_unify_schema from '~/meta/migrations/v2/nc_079_unify_schema';
import * as nc_080_default_workspace from '~/meta/migrations/v2/nc_080_default_workspace';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_078_deprecate_unused',
      'nc_079_unify_schema',
      'nc_080_default_workspace',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_078_deprecate_unused':
        return nc_078_deprecate_unused;
      case 'nc_079_unify_schema':
        return nc_079_unify_schema;
      case 'nc_080_default_workspace':
        return nc_080_default_workspace;
    }
  }
}
