...
import * as nc_099_shared_base_access_requests from '~/meta/migrations/v2/nc_099_shared_base_access_requests';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_099_shared_base_access_requests',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_099_shared_base_access_requests':
        return nc_099_shared_base_access_requests;
    }
  }
}
