...
import * as nc_079_hook_trigger_fields from '~/meta/migrations/v2/nc_079_hook_trigger_fields';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_079_hook_trigger_fields':
        return nc_079_hook_trigger_fields;
    }
  }
}
