...
import * as nc_099_add_enabled_to_filter_exp_v2 from '~/meta/migrations/v2/nc_099_add_enabled_to_filter_exp_v2';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_099_add_enabled_to_filter_exp_v2',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_099_add_enabled_to_filter_exp_v2':
        return nc_099_add_enabled_to_filter_exp_v2;
    }
  }
}
