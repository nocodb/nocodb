...
import * as nc_079_row_color_conditions from '~/meta/migrations/v2/nc_079_row_color_conditions';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_079_row_color_conditions':
        return nc_079_row_color_conditions;
    }
  }
}
