export enum MetaTable {
  ...
  DASHBOARD = 'nc_dd_dashboard_v2',
  WIDGET = 'nc_dd_widget_v2',
  DASHBOARD_PROJECT_DB_PROJECT_LINKINGS = 'nc_dd_dashboard_project_db_project_linkings_v2',
  WIDGET_DB_DEPENDENCIES = 'nc_dd_widget_db_dependencies_v2',
  STORE = 'nc_store',
  BOOK = 'nc_books',
  WORKSPACE = 'workspace',
