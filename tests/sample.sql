...
--
/*!50003 DROP PROCEDURE IF EXISTS `set_credit_limit` */;
...
CREATE DEFINER=`root`@`%` PROCEDURE `set_credit_limit`(IN customerNumber INT(11), IN creditLimit decimal (10,2))
BEGIN
END;
...
-- Dump completed on 2020-05-29  6:07:09
